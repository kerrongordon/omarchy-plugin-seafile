...
Item {
  ...
  readonly property string _remoteScript: _pyHttp + "\n" + [
    ...
    "      # The shape actually returned by deployed Seahub servers (confirmed",
    "      # live): id/desc/ctime/creator_name.",
    "      for c in commits[:50]:",
    ...
    "    else:",
    "      # Newer shape documented in seahub/api2/endpoints/repo_history.py",
    "      # on GitHub's master branch (data/commit_id/description/time(ISO)/",
    "      # name) -- not seen on any server tested against, but handled in",
    "      # case a future server version switches to it.",
